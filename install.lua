...
local RunBot = io.open("Nazuki", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Nazuki
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Nazuki.lua
wget "https://raw.githubusercontent.com/NazukiTEAM/Nazuki/main/Nazuki.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Nazuki.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Nazuki -X kill
screen -S Nazuki ./Nazuki
done
]])
RunTs:close()
end
